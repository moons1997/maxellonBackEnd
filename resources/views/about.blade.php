...
@section('content')
    ...
    <div class="about">
                ...
                <div class="container">
                    <div class="about-header_content">
                        <div class="about-header_content__img">
                            <img src="{{asset('b_images/section/'.$section_1->img)}}" alt="about-header" />
                        </div>
        ...
        @if(!empty($section_2))
            <section
                class="section induidal about-induidal"
                style="background-image: url({{asset('b_images/section/'.$section_2->img)}})"
        >
            <div class="container">
                <div class="text_anime">
        ...
        @if(!empty($section_3))
                <section class="section about-footer dark_scroll">
                    <div class="container">
                        <div class="about-header_content">
                            <div class="about-header_content__img">
                                <img src="{{asset('b_images/section/'.$section_3->img)}}" alt="about-footer" />
                            </div>
                            <div class="about-header_content__info">
                                <div class="text_anime">
                                    <h1 class="about-header__title">
                                        <span>{{$section_3->title}}</span>
                                    </h1>
                                </div>
        ...
        @if(!empty($section_4))
                <section class="section values">
                    <div class="container">
                        <div class="values_container values_deck">
                            <h1 class="values-title">Ценности</h1>
                                      ...
                                      @for($i = 0;$i < 3; $i++ )
                                          <div class="values-item">
                                              <div class="values-item__icon">
                                                <img
                                                        src="./b_images/section/{{$section_4[$i]->img}}"
                                                        alt="values-icon"
                                                />
                                              </div>
                                              <h2 class="values-item__title">
                                                {{$section_4[$i]->title}}
                                              </h2>
                                          </div>
                                      @endfor
                        ...
                        <div class="values_mob">
                            <h1 class="values-title">Ценности</h1>
                            <div class="swiper-container values-block">
