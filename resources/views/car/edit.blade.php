...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Update car section</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">update car section</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card card-primary">
                            <div class="card-body card-info">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="sub_title" type="text" class="form-control" id="sub_title" value="{{$car->sub_title}}" placeholder="Enter top text">
                                </div>
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input name="title" type="text" class="form-control" id="title" value="{{$car->title}}" placeholder="Enter title">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-body card-info">
                                ...
                                <div class="form-group visible_img">
                                    ...
                                    <div class="upload-img" style="width: 180px; margin: 25px auto;">
                                        <img style="width: 100%" src="{{asset('./b_images/section/'.$car->img_visible)}}" data-default="{{asset('./b_images/section/'.$car->img_visible)}}" alt="img">
                                    </div>
                                ...
                                <div class="form-group hidden_img">
                                    ...
                                    <div class="upload-img" style="width: 180px; margin: 25px auto;">
                                        <img style="width: 100%" src="{{asset('./b_images/section/'.$car->img_hiddin)}}" data-default="{{asset('./b_images/section/'.$car->img_hiddin)}}" alt="img">
                                    </div>
                                    <div class="input-group">
                                        <div class="custom-file">
