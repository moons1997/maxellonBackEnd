...
@section('content')
    <section class="section delivery contact">
        <div class="container">
            ...
            <div class="text_anime">
                  <span>
                    <div class="advantage_box">
                      <div class="advantage_box__item right left">
                        <div class="right_b">
                          <div class="contact__title">Головной офис</div>
                          ...
                          <div class="advantage_box__info">
                            <a href="tel:+998 78 1400775">+998 78 1400775</a>
                          </div>
                          <div class="advantage_box__info info__bold">
                            Эл. Почта:
                          </div>
                          <div class="advantage_box__info">
                            <a href="mailto:info@maxcellon.uz"
                            >info@maxcellon.uz</a
                            >
                          </div>
                        </div>
            ...
            <div class="text_anime">
                <h2 class="dp-page__title">
                    <span>Отдел прадаж</span>
                </h2>
            </div>
            <div class="sale__info">
                <div class="left">
                    <div class="sale__info-title">Телефон:</div>
                    <div class="sale__info-call">
                        <a href="tel:+998 78 1400775">+998 78 1400775</a>
                    </div>
                </div>
                <div class="right">
                    <div class="sale__info-title">Эл. Почта:</div>
                    <div class="sale__info-call">
