...
@section('content')
    <div class="installment">
        ...
        @endif
            <section class="section dp-page advantage customer dark_scroll">
                <div class="container">
                    <div class="dp-page_content">
                        <div class="text_anime">
                            <h2 class="dp-page__title">
                                <span> За этот период у клиентов есть возможность</span>
                            </h2>
                        </div>
                      ...
                      <div class="advantage_box">
                        <div class="advantage_box__item">
                          <h2 class="advantage_box__title">
                            Проверить продолжительность ежедневной работы (часов
                            в сутки)
                          </h2>
                        </div>
                        <div class="advantage_box__item">
                          <h2 class="advantage_box__title">
                            Проверить предельные тяговые нагрузки
                            (грузоподъемность)
                          </h2>
                        </div>
                      </div>
                    ...
                    <span>
                      <div class="advantage_box">
                        <div class="advantage_box__item text">
                          <h2 class="advantage_box__title">
                            В итоге у клиента складывается ясное мнение об АКБ.
                          </h2>
                        </div>
                      </div>
                    </span>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="advantage_box__item">
                                            <h2 class="advantage_box__title">
                                                Проверить продолжительность ежедневной работы
                                                (часов в сутки)
                                            </h2>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="advantage_box__item text">
                                            <h2 class="advantage_box__title">
                                                В итоге у клиента складывается ясное мнение об
                                                АКБ.
                                            </h2>
                                        </div>
                                    </div>
